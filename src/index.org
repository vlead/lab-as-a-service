...
* Introduction
  This is the architecture document of the platform that runs experiments.  The
  document also provides a blue print on how an experiment is designed to
  leverage the platform.

* Structure of an Experiment
  An experiment is a set of learning objective that are met by well-defined
  phases each consisting of steps or micro-activities composed in a meaningful
  manner.

  Phase - a composite of activities that cognitively engage the learner. These
...
** Components
   - Hosted Content :: The resources could be either an NPTEL lecture hosted on
                       youtube or a virtual lab hosted by VLEAD (Virtual Labs
                       Engineering and Architecture Division) or any other
